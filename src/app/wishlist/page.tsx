    ...
    <div key={`${product?._id}-${index}`} className="bg-white p-4 rounded-lg shadow-lg hover:shadow-xl transition">
                                ...
                                <Link href="/shop" className="text-blue-500 hover:underline">Continue Shopping</Link>
                                    <Image
                                       ...
                                       width={500}
                                       height={500}
                                       className="object-cover object-contain rounded-lg transition-transform transform hover:scale-105"
                                    />
                                </div>
                                <div className="mt-4">
                ...
                <div className="flex flex-col items-center justify-center h-screen text-gray-500">
                    ...
                    <Link href="/shop" className="mt-4 text-blue-500 hover:underline">Browse Products</Link>
                </div>
            )}
        </div>
    );
